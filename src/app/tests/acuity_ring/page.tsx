...
export const metadata: Metadata = {
  ...
  description: "Test your visual acuity with the Landolt Ring chart. Identify the direction of the gap in the ring as it gets smaller. A classic test for sharpness of vision.",
};
